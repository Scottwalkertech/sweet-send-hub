...
function SiteFooter() {
  return (
    <footer className="w-full border-t border-slate-200 bg-white text-slate-600">
      <div className="max-w-5xl mx-auto px-6 py-6 text-center text-xs sm:text-sm leading-relaxed">
        Need assistance? Contact our secure support team directly at{" "}
        <a href="mailto:info@dynamicbankofwest.com" className="font-medium text-slate-900 hover:text-amber-700">
          info@dynamicbankofwest.com
        </a>
        . Available 24/7 for account verifications, wire processing, and customer inquiries.
      </div>
    </footer>
  );
}
